...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="kuaidiListNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="物流状态" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //物流状态
            var kuaidiListNameSearchInput = $('#kuaidiListNameSearch');
            if( kuaidiListNameSearchInput != null){
                if (kuaidiListNameSearchInput.val() != null && kuaidiListNameSearchInput.val() != '') {
                    searchForm.kuaidiListName = $('#kuaidiListNameSearch').val();
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("kuaidiList/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                kuaidiListName: searchForm.kuaidiListName,
            //级联表的
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addkuaidiList", "addkuaidiList");
            window.location.href = "add-or-update.jsp"
        }
