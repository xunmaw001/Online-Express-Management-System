                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>区域</label>
                                        <select id="quyuTypesSelect" name="quyuTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationQuyutypesSelect(){
            var quyuTypesSelect = document.getElementById('quyuTypesSelect');
            if(quyuTypesSelect != null && quyuTypesOptions != null  && quyuTypesOptions.length > 0 ){
                for (var i = 0; i < quyuTypesOptions.length; i++) {
                    quyuTypesSelect.add(new Option(quyuTypesOptions[i].indexName,quyuTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(quyuTypesSelect != null && quyuTypesOptions != null  && quyuTypesOptions.length > 0 ) {
            for (var i = 0; i < quyuTypesOptions.length; i++) {
                if (quyuTypesOptions[i].codeIndex == ruleForm.quyuTypes) {//下拉框value对比,如果一致就赋值汉字
                        quyuTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
